...
const Tiles = () => {
  return (
    <div className='flex flex-row gap-2'>
      ...
      <SalesContainer time="Last month" date="Dec 1 - Dec 31" bg="fifth" sales="20,006.28" orders="1752" units="2084" refunds="" cost="71" payout="11,523.67" gross="9,669.73" net="5,006.73" topLoss={"+3.5%"} downLoss={"-37.7%"}/>
    </div>
  )
}
